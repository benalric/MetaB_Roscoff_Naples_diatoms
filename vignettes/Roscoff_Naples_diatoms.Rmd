...
```
In this script, the primers need to be specified.<br/>Here, we used as gene marker, the 18S rDNA V4 region and the associated eukaryotic-specific primers developped by [Stoeck et al. (2010)](https://onlinelibrary.wiley.com/doi/10.1111/j.1365-294X.2009.04480.x):
